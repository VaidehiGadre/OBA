 ...
 * @Entity
 * 
 * @Table(name = "usertable") public class User implements Serializable {
 * 
 * @Id
 * 
 ...
 * if(obj==null || !(obj instanceof User)){ return false; } User u=(User)obj;
 * return u.id.equals(this.id); }
 * 
 * 
 * @Override public int hashCode() { if(id==null){ return 0; } return
 * id.hashCode(); } }
 */